            ...
            if (number == 1) {
                ...
                for (Drink s : svm.getDrinks()) {
                    if (s.getName().equals(userChoice)) {
                        ...
                        int index = (Arrays.asList(drinkArr2).indexOf(s));
                        Drink fields = ArrayUtils.removeElement(drinkArr2, drinkArr2[index]);

                        System.out.println(Arrays.toString(svm.getDrinks()));
                    }else if(s.getName().equals(null)||s.getName().equals("null")){
                        System.out.println("Данного напитка нет");
                    }
                }/*else if(number == 2) {
                continue;
            }else{
